...
export class Taskbar {
	...
	constructor(system: System, ctx: CanvasRenderingContext2D) {
	...
	splice(value: number | string) {
		...
		if (!e) return;
		const tab = this.parent.elemente[this.parent.elemente.indexOf(e[0])] as Rect;
		const tabText = this.parent.elemente[this.parent.elemente.indexOf(e[1])] as Text;
